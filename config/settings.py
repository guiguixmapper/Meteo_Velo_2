...
FONDS_CARTE = {
    ...
    "🏔️ IGN Topo (Précis)": (
        "https://data.geopf.fr/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=GEOGRAPHICALGRIDSYSTEMS.MAPS&STYLE=normal&FORMAT=image/png&TILEMATRIXSET=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&apikey=choisirgeoportail",
        "© <a href='https://www.ign.fr/' target='_blank'>IGN</a> / Géoplateforme"
    ),
