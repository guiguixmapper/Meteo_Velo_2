...
# CORRECTIF : import remonté en tête de fichier (était dans le corps de
# extraire_meteo(), ré-exécuté à chaque appel sans raison).
...
def recuperer_uv_pollen(lat: float, lon: float, date_str: str) -> dict:
    ...
    return res    if uv >= 3:  return ("🟡", "Modéré", "#eab308")
